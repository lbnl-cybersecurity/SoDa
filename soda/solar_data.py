...
class SolarSite(object):
    ...
    def get_nsrdb_data(self,year,leap_year,interval,utc):
        ...
        your_name = YOUR_NAME # Your full name, use '+' instead of spaces.
        reason_for_use = REASON_FOR_USE # Your reason for using the NSRDB.
        your_affiliation = YOUR_AFFILIATION # Your affiliation
        your_email = YOUR_EMAIL # Your email address
